                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form method="POST" action="ServletLogin" class="form-signin">
                            ...
                            <input type="text" name="nvusername" class="form-control" placeholder="Nom d'utilisateur" required><br>
                            <input type="password" name="nvpassword" class="form-control" placeholder="Mot de passe" required><br>
                            <input type="password" name="nvpassword2" class="form-control" id="UserPassword2" placeholder="Confirmer mot de passe" required><br>
